...
import { LayoutDashboard, LogOut, PanelLeft, Users, Zap, TrendingUp, BookOpen, Shield, FileText, Lightbulb } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Zap, label: "Connectors", path: "/connectors" },
  { icon: TrendingUp, label: "Paper Trading", path: "/paper-trading" },
  { icon: Lightbulb, label: "Signals", path: "/signals" },
