...
// ── Daily Moonshot Play (Retired) ──────────────────────────────────────────
// Moonshot execution is now handled natively by kalshiAutonomy.ts within
// the regular schedule loop, bound by MOONSHOT_MAX_TOTAL_USD.
